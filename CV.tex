...
\cventry{10/2019 -- today}{Architect}{CoBloX}{Sydney (Australia)}{full-time}{
    Accountable for designing and engineering the COMIT protocol specification and the Rust reference implementation
}
\cventry{03/2018 -- 10/2019}{Research Engineer}{CoBloX}{Sydney (Australia)}{full-time}{
    Responsible for development on the Rust reference implementation of the COMIT protocol. Notable technologies included are: Rust, Typescript, libp2p, Bitcoin and Ethereum.
}
\cventry{10/2017 -- 02/2018}{Software Developer}{Willhaben.at}{Vienna (Austria)}{full-time}{
    Responsible for maintainence and extension of the core Java codebase. Major contributions include the design of WHML (Willhaben Markup Language), a declarative, domain-specific language for UIs. Notable technologies include: Spring Boot, Tomcat, Cybase and Postgres.
}
\cventry{09/2015 -- 06/2017}{Software Developer}{Senacor Technologies AG}{Vienna (Austria)}{part-time}{
...
\cventry{07/2014 -- 06/2015}{Intern}{IBM Softwaregroup Wien}{Vienna (Austria)}{part-time}{
    Responsible for configuration of standard software as well as development of plugins or other extentions at various client sites. Notable technologies include: IBM Content Navigator, IBM WebSphere, Spring Boot and DB2.
}
\cventry{01/2014 -- 12/2014}{Software Developer}{Akademikerhilfe Wien}{Vienna (Austria)}{part-time}{
    Responsible for maintainence and extension of a traffic contingent management software for student dorms. Notable technologies include: PHP, iptables, SNMP and Linux.
}
\cventry{07/2013}{Intern}{T-Mobile Austria E-Business}{Vienna (Austria)}{full-time}{
    Responsible for development of various productivity tools for co-workers. Major contributions include reducing a weekly task from 4 hours to 15 minutes through automation. Notable technologies are: C\texttt{\#}, SQL, Microsoft Excel and WPF
}
...
\cventry{since 05/2018}{Curriculum vitae continous deployment}{}{}{}{As a fun exercise and to ease changes to my CV, I version the TeX source files on GitHub and automatically deploy all changes to my website: \url{github.com/thomaseizinger/curriculum-vitae}}
...
\cventry{Daniel Kahneman}{Thinking, Fast and Slow}{2011}{}{}{}
